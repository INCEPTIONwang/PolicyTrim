...
# Fix Vulkan ICD path for ManiSkill rendering.
...
bash examples/embodiment/run_embodiment.sh maniskill_grpo_openvlaoft \
  "cluster.num_nodes=1" \
  "~cluster.component_placement" \
  "+cluster.component_placement={actor:0-7,rollout:4-7,env:0-3}" \
  "rollout.pipeline_stage_num=2" \
  "actor.model.model_path=models/RLinf-OpenVLAOFT-GRPO-ManiSkill3-25ood" \
  "rollout.model.model_path=models/RLinf-OpenVLAOFT-GRPO-ManiSkill3-25ood" \
